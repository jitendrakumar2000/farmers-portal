    ...
    <img src="images/Cereal1.png" alt="CEREAL BOARD MANAGEMENT" style ="width: 9%;float: left;margin-left: -10%; margin-top: -2%;">
            <div id="header" >
                ...
                <h1><a href="index.php" target="_parent">
				   CEREALS BOARD FARMERS PORTAL <p style="font-size: 11px;float: right;padding: 1%;margin-right: 3%;">Today is :  <?php echo date("l");echo " ";echo date("M,d,Y");?></p>
                    </a></h1>
            </div>
    ...
    border-bottom-left-radius: 5%; border-bottom-right-radius: 5%;">
        ...
        <div id="menu">
			...
			<div id="myDIV">
				...
				<li><a href="manageverifysaccomembers.php"><span></span>Members</a></li>
				...
				<li><a href="farmerrecord.php"><span></span>Farmers Records </a></li>
				
				<li><a href="account.php"><span></span>My Account </a></li>
				
				<div style="background: rgba(70, 83, 76, 0.52); margin-left: 86%;margin-top: -4%;height: 46px;">
				<li style="background: #808035;border: none;padding: 0px;"> <img src="images/pf.png" alt="profilepic" style ="width: 46%;margin-left: -8%;"><a href="logout.php" style="float: right;margin-right: 30%;margin-top: -45%;font-family: cursive;font-size: 12px;"><span></span>Logout </a></li>
				...
				<?php if($logedin==3){ ?>
				 <li class="btn"><a href="info.php"> <span></span>Information </a></li>
				 <li><a href="managesaccos.php"><span></span>Manage Saccos </a></li>
				 <li><a href="approve.php"><span></span>Approve Payment </a></li>
				<li><a href="farmerrecord.php"><span></span>Farmers Records </a></li>	
                ...
                <li style="color: chartreuse;float: right;margin-top: -21%;padding: 0%;background-color: rgba(128, 128, 53, 0.22); border: none; margin-right: 20%;font-size: 14px; font-family: serif;"><span></span><?php echo $use_name ?> </a></li>
				</div>
				...
				<li><a href="deliveries.php"><span></span>My Deliveries</a></li>
				<li><a href="payments.php"><span></span>Payments Recieved  </a></li>
